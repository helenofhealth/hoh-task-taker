CREATE TABLE public.notification_preferences (
  ...
  inapp_status boolean NOT NULL DEFAULT true,
  inapp_assignments boolean NOT NULL DEFAULT true,
...
CREATE POLICY "notif prefs upsert own" ON public.notification_preferences
